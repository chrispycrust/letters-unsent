...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var dummyLetters, _i, dummyLetters_1, letter;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _i = 0, dummyLetters_1 = dummyLetters;
                    _a.label = 1;
                case 1:
                    if (!(_i < dummyLetters_1.length)) return [3 /*break*/, 4];
                    letter = dummyLetters_1[_i];
                    return [4 /*yield*/, prisma.letter.create({
                            data: letter
                        })];
                case 2:
                    _a.sent();
